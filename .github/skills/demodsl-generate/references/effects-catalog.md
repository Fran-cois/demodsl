...
| Effect | Class |
|--------|-------|
| `bloom` | `_RemotionPostEffect` |
| `bokeh_blur` | `_RemotionPostEffect` |
| `camera_shake` | `_RemotionPostEffect` |
| `chromatic_aberration` | `_RemotionPostEffect` |
| `color_grade` | `_RemotionPostEffect` |
| `crt_scanlines` | `_RemotionPostEffect` |
| `dissolve_noise` | `_RemotionPostEffect` |
| `dolly_zoom` | `_RemotionPostEffect` |
| `drone_zoom` | `_RemotionPostEffect` |
| `elastic_zoom` | `_RemotionPostEffect` |
| `fade_in` | `_RemotionPostEffect` |
| `fade_out` | `_RemotionPostEffect` |
| `film_grain` | `_RemotionPostEffect` |
...
| `light_leak` | `_RemotionPostEffect` |
| `parallax` | `_RemotionPostEffect` |
| `pixel_sort` | `_RemotionPostEffect` |
| `reverse` | `_RemotionPostEffect` |
| `rotate` | `_RemotionPostEffect` |
| `slide_in` | `_RemotionPostEffect` |
| `speed_ramp` | `_RemotionPostEffect` |
| `tilt_shift` | `_RemotionPostEffect` |
| `vhs_distortion` | `_RemotionPostEffect` |
| `vignette` | `_RemotionPostEffect` |
| `whip_pan` | `_RemotionPostEffect` |
| `wipe` | `_RemotionPostEffect` |
| `zoom_pulse` | `_RemotionPostEffect` |
| `zoom_to` | `_RemotionPostEffect` |
